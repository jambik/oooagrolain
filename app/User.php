...
{
    use EntrustUserTrait, ImageableTrait, ResourceableTrait, LogsActivity;

    protected $table = 'users';

    protected $fillable = ['name', 'email', 'phone', 'password', 'provider_id', 'provider', 'avatar', 'image'];

    protected static $logAttributes = ['name', 'email', 'phone', 'password', 'provider_id', 'provider', 'avatar', 'image'];
